...
<div class="container-fluid">
    ...
    <div  class="list-group list-group-horizontal">   
		...
		$queryget = $_GET['query']; 
        //get rows query
        $query = $db->query("SELECT distinct products_name,name,quantity,price,hotdeal_price,offer_price,id  FROM products where products_name like '%".$queryget."%' and status=1 ORDER BY products_name");
        if($query->num_rows > 0){ 
        ...
        <div class="item col-xs-6 col-sm-2">
					...
					<div class="row" align="center">
						<div class="col-sm-12">
							...
							<a name="product_details" style="text-decoration:none;color:fff" href="details.php?id=<?php echo $row["id"];?>"><h5 class="h5"  style="font-weight:bold;padding-top:10px;height:45px;"><?php echo $row["products_name"]; ?></h5></a> 
        ...
        <?php } }else{ ?>
			<p class="lead" style="color:red"><b>Your Searching Items Not Available!</b></p>
        <?php } ?>
