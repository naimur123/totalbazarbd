...
function customerviewProductPrice($db){
        ...
        while($data = $stmt->fetch(PDO::FETCH_OBJ)){
			...
			$this->Cell(25,8,'Sub Total Price: ',0,0,'L');
            $this->Cell(140,8,$data->sub_total_price,0,0,'L');
			$this->Ln();
            $this->Cell(25,8,'Shipping Fee: ',0,0,'L');
			$this->Cell(120,8,$data->shipping_cost,0,0,'L');
			$this->Ln();
			$this->Cell(25,8,'Discount Amount: ',0,0,'L');
            $this->Cell(140,8,$data->discount_amount,0,0,'L');
			$this->Ln();
			$this->Cell(25,8,'Grand Total: ',0,0,'L');
            $this->Cell(120,8,$data->total_price,0,0,'L');
			$this->Ln();
