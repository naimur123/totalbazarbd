...
<html>
	...
	<body>
		<div class="container-fluid">
			...
			<div class="row">
				<h2 class="h2" align="center"><b>Scrolling Notification</b></h2>
			</div>
			...
			<div class="row">
				...
				<br />
				<div align="right">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info"><span class="glyphicon glyphicon-plus-sign"></span> Add New Notification</button>
				</div>
				<br />
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<b style="color:red">***</b><label> Enter Notification</label>
