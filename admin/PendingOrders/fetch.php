...
// else
// {
// 	//$search_query .= 'ORDER BY orders.id asc';
// }
...
foreach($result as $row)
{
	...
	$sub_array[] = $row["additional_comment"];
	...
	$sub_array[] = '<a href="updateOrder.php?oid='.$row["id"].'". target="_blank" class="btn btn-warning btn-xs update">Update</a>';
