...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:gray">
			<h4 class="h4" style="color:#fff">Research Books</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT * FROM `products` WHERE `prdsubcategory` ='Research Books' and status='1'ORDER BY products_name");
        if($query->num_rows > 0){ 
        ...
        <?php } }else{ ?>
			<p class="lead" style="color:red"><b>Research Books NOT AVAILABLE!</b></p>
        <?php } ?>
