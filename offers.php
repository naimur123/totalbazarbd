...
<div class="container-fluid">
    ...
    <div  class="list-group list-group-horizontal">    
        ...
        $query = $db->query("SELECT * FROM `products` where offer_item='1' order by products_name LIMIT $limitStart ,30");
        if($query->num_rows > 0){ 
	...
	// Pagination List Here
	    $query = $db->query("SELECT * FROM `products` where offer_item='1'");
