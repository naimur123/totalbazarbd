...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:gray">
			<h4 class="h4" style="color:#fff">Water</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
        ...
        $query = $db->query("SELECT * FROM `products` WHERE `prdsubcategory` ='Water' and status='1' ORDER BY products_name LIMIT $limitStart ,30");
        if($query->num_rows > 0){ 
        ...
        <?php } 
			...
			<p class="lead" style="color:red"><b>Water Items NOT AVAILABLE!</b></p>
        <?php } ?>
	...
	// Pagination List Here
	    $query = $db->query("SELECT * FROM `products` WHERE `prdsubcategory` ='Water' and status='1'");
