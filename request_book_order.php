<?php
	...
	if(isset($_POST['btnsavebookimage']))
	{
		...
		{
			$upload_dir = 'admin/include/images/book_order/'; // upload directory
		...
		<div class="col-md-5">
				...
				<table class="table table-bordered table-responsive">
					...
					<thead style="background-color:#DE1234;color:white">						
						<tr>
							<td colspan="2"><h4 class="h4" align="center"><b>Request for Book</b></h4></td>
						</tr>
					</thead>
					<tbody>
					...
					<tr>
						...
						<td><textarea class="form-control" placeholder="Insert Your Book Name" style="width:100%" name="book_name"></textarea></td>
					</tr>
