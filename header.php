...
<div class="shoppingcart">
		...
		<div align="center" ><img src="Shopping-Cart-Icon.png" alt="My Bag" style="width:60px;height:70px;"></div>
		
		<p class="pv" style="color:black;">
			
		<b style="color:black;"> My Cart  <br/>
		<div class="text-center" id="cart_item" style="color:black;">(
...
<div class="container-fluid" style="background-color:##E9E6E2;height:60px;padding:5px" !important>
    ...
    <div class="col-md-6" align="center" style="padding-top:30px;background-color:red;color:white;">
...
$sql = "SELECT notification FROM scrolling_notification where status=1";
...
?>
	...
	<div class="col-md-2 pv" align="center" style="padding-top:0px;" >
	    <p class="pv" style="color:#08B066;font-weight: bold"><h5><b><span class="glyphicon glyphicon-earphone" style="color:#EE3232;font-weight: bold" height="40px"> </span> 01977868484, 01302254543</b></h5></p>
	...
	<div class="col-md-2 pv" align="center" style="padding-top:12px;"> 		
...
<nav class="navbar navbar-default navbar-custom" data-spy="affix" data-offset-top="197" style="width:100%">   
                ...
                <ul class="nav navbar-nav "> 
							...
							<li><a href="promotional.php" style="color: #ffffff;">Promotional</a></li>
							
							<li><a href="ramadan2019.php" style="color: #ffffff;background-color:red;">Ramadan</a></li>
                			...
                			<li>
                				<a href="bookstationary.php" style="color: #ffffff;">Books</a>								
                			</li>
							...
							<li><a href="carvehicles.php" style="color: #ffffff;">Vehicles</a></li>
							
							<li>
                				<a href="sport.php"  style="color: #ffffff;">Sports</a>						
                			</li>							
							
							<li style="">
                				<a href="request_daily_bazar.php"  style="color: #ffffff;">Request</a>						
                			</li>
                </ul>   
				</div>
