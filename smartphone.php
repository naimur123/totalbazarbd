...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12" align="center" style="background-color:#3964B9">
			<h4 class="h4" style="color:#fff">SMARTPHONE</h4>
		</div>
	</div>
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT * FROM products where products_category='Smartphone' ORDER BY id");
        if($query->num_rows > 0){ 
        ...
        <?php } }else{ ?>
			<p class="lead" style="color:red"><b>Smartphone Not Available!</b></p>
        <?php } ?>
