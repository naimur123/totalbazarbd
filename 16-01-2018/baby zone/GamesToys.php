...
<div class="container-fluid">
    ...
    <div  class="list-group list-group-horizontal">    
		<?php
        //get rows query
        $query = $db->query("SELECT * FROM `products` WHERE `prdsubcategory` ='Games & Toys' and status='1' ORDER BY products_name");
        if($query->num_rows > 0){ 
        ...
        <?php } }else{ ?>
			<p class="lead" style="color:red"><b>Games & Toys NOT AVAILABLE!</b></p>
        <?php } ?>
